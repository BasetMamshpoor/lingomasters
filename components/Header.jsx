                ...
                <div className="container flex flex-col gap-6 sm:px-10">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="centerOfParent gap-4">
                            ...
                            {/* <Link href='/checkout/cart' className="relative px-1.5 py-1 centerOfParent border-1.5 rounded border-secondary-500 hidden">
                    ...
                    <div className="lg:flex items-center justify-center hidden w-full">
                        <Input radius="sm" placeholder="جستجو استاد، دوره آموزشی و ..." isClearable variant="bordered" className="max-w-[628px] bg-white" startContent={<Search className="fill-natural_gray-600" />} />
                    </div>
                                    ...
                                    <li key={o} className="[&>a]:flex [&>a]:items-center [&>a]:gap-3 cursor-pointer">{i.underMenu ?
                                        <Dropdown dir="rtl">
                                            ...
                                            <DropdownMenu className="max-h-64 overflow-y-auto scrollbar-hide scrollbar scrollbar-w-8 scrollbar-thumb-natural_gray-800 scrollbar-track-white">
                                                {[].map(c => <DropdownItem key={c.slug} ><Link className="w-full block" href={`/category/${c.slug}`}>{c.title}</Link></DropdownItem>)}
                                            </DropdownMenu>
                                        </Dropdown>
