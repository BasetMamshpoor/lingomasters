                ...
                <div className="flex flex-col md:col-span-7 w-full gap-6">
                    <div className="flex flex-col gap-6 justify-between">
                        ...
                        <div className="flex items-start gap-3 justify-between">
                            ...
                            <Like id={r.id} isLike={r.is_like} url='/workshop-reserve'/>
                        </div>
                        <div className="gap-8 h-full w-full flex flex-col items-center">
                            <div
                                className="grid gap-4 grid-cols-2 [&>div]:h-8 w-full [&>div]:rounded-md [&>div]:bg-primary-50 [&>div]:flex [&>div]:flex-wrap [&>div]:items-center [&>div]:justify-center [&>div]:gap-1 text-xs [&>div>span]:whitespace-nowrap">
                                <div className='col-span-1'>
                                    <span className="text-natural_gray-700">استاد</span>
                                    <span className='line-clamp-1'> {r.professor}</span>
                                </div>
                                <div className='col-span-1'>
