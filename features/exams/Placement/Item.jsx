        ...
        <>
            <div
                ...
                {step === 1 ? <>
                    ...
                    <p className="text-xs md:text-base lg:text-lg text-secondary-500">✦تعیین سطح آنلاین</p>
                    <div className="flex flex-col gap-8">
                        <p className="text-base md:text-2xl lg:text-5xl font-bold text-primary-600 whitespace-nowrap">همین
                            امروز مهارت زبانت رو بسنج!</p>
