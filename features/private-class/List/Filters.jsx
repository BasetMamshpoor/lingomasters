            ...
            {data ?
                <div
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        >
                            {Object.keys(weekDays.periods).map(c => <Checkbox classNames={{icon: 'text-white'}} key={c}
                                                                              value={c}>{c}</Checkbox>)}
                        </CheckboxGroup>
                    </div>
                    <div className="flex flex-col gap-4">
                        ...
                        <div className='grid grid-cols-2 gap-y-4'>
                            {data.near?.map(c => {
                                return <Checkbox
                                    ...
                                    color='success'
                                    isSelected={Array.isArray(filters.near) ? filters.near[0].value : filters.near === c.value}
                                    onValueChange={e => handleFilter('near', e ? c.value : null)}
                                    classNames={{icon: 'text-white'}} key={c.value}
                                    value={c.value}>{c.name}</Checkbox>
                            })}
                        </div>
                    </div>
                </div>
