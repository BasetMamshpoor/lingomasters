...
import {addToast, BreadcrumbItem, Breadcrumbs, Popover, PopoverContent, PopoverTrigger} from "@heroui/react";
            ...
            <div className="lg:hidden flex flex-col">
                <div className="py-3">
                    <Breadcrumbs
                        ...
                        <BreadcrumbItem
                            className='[&>span]:sm:text-base [&>span]:text-xs [&>a]:sm:text-base [&>a]:text-xs'
                            href='/group-class'>کلاس های گروهی</BreadcrumbItem>
                        <BreadcrumbItem
                    ...
                    <div className="gap-10 flex flex-col items-center">
                        <div className="gap-2 w-full flex flex-col items-center">
                            ...
                            <div className="gap-2 w-full lg:flex hidden flex-col">
                                <div className="bg-natural_gray-50 px-3 py-2  flex items-center justify-between">
                                    ...
                                    <p className="text-primary-700 text-sm">{data.sessions_count} جلسه</p>
                                </div>
                        ...
                        <div
                            ...
                            <div className="flex flex-col items-center gap-4">
                                <p className="text-natural_gray-900 text-xs">قیمت دوره</p>
                                <div className="flex  justify-end gap-2">
                                    {data.price !== data.price_discount &&
