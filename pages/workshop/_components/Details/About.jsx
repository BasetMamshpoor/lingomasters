                ...
                <div
                    ...
                    <ul className="flex flex-col gap-4 grow">
                        <li className='grid grid-cols-5 sm:text-base text-xs'>
                            ...
                            <span className="col-span-3 text-right">ورکشاپ</span>
                        </li>
                        <li className='grid grid-cols-5 sm:text-base text-xs'>
                        ...
                        <li className='grid grid-cols-5 sm:text-base text-xs'>
                            ...
                            <span className="col-span-3 text-right ">حضوری</span>
                        </li>
                        <li className='grid grid-cols-5 sm:text-base text-xs'>
                        ...
                        <li className='grid grid-cols-5 sm:text-base text-xs'>
                            <span className='text-natural_gray-950'>کشور / شهر</span>
                            <span className="col-span-3 text-right">{data.city}</span>
                        </li>
                        <li className='grid grid-cols-5 sm:text-base text-xs'>
