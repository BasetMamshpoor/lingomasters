...
const Reserve = () => {
    ...
    const handlePay = async () => {
        ...
        const {
            ...
            success,
            errorMessage
        } = await sendPostRequest("POST", `/group_reserve/pay/${id}`, {}, false, true)
        if (success) {
            console.log(Data)
        } else
            addToast({
        ...
        <>
            <main className='my-6' dir='rtl'>
                {!loading ? <div className="container">
                    <Progress active={steps} steps={stepsList} page='احسان علیزاده' title='کلاس های گروهی'
                              link='/group-class'/>
                    {data && <div className="grid lg:grid-cols-4 grid-cols-1 lg:gap-6 gap-y-6 my-10">
                        <div
