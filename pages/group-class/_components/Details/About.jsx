                ...
                <div className="flex sm:flex-row flex-col-reverse sm:items-start items-stretch sm:gap-0 gap-4 justify-between">
                    <ul className="flex flex-col gap-4 grow">
                        <li className='grid grid-cols-5 sm:text-base text-xs'>
                            ...
                            <span className="col-span-3 text-right">انگلیسی</span>
                        </li>
                        <li className='grid grid-cols-5 sm:text-base text-xs'>
                            <div className="col-span-2 flex items-center gap-2">
                            ...
                            <span className="col-span-3 text-right">۴۰ نفر</span>
                        </li>
                        <li className='grid grid-cols-5 sm:text-base text-xs'>
                            <div className="col-span-2 flex items-center gap-2">
                            ...
                            <span className="col-span-3 text-right">بزرگسال</span>
                        </li>
                        <li className='grid grid-cols-5 sm:text-base text-xs'>
                            <div className="col-span-2 flex items-center gap-2">
                                <div className="centerOfParent"><Star className='sm:w-4 sm:h-4 w-3 h-3 fill-primary-800' /></div>
                                <span className='text-natural_gray-950'>سطح دوره</span>
                            </div>
                            <span className="col-span-3 text-right">پیشرفته</span>
                        </li>
                        <li className='grid grid-cols-5 sm:text-base text-xs'>
                            <div className="col-span-2 flex items-center gap-2">
                                <div className="centerOfParent"><History className='sm:w-4 sm:h-4 w-3 h-3 fill-primary-800' /></div>
                                <span className='text-natural_gray-950'>مدت زمان دوره</span>
                            </div>
                            <span className="col-span-3 text-right ">۲۰ جلسه</span>
                        </li>
                        <li className='grid grid-cols-5 sm:text-base text-xs'>
                            <div className="col-span-2 flex items-center gap-2">
                                <div className="centerOfParent"><Map className='sm:w-4 sm:h-4 w-3 h-3 fill-primary-800' /></div>
                                <span className='text-natural_gray-950'>موقعیت</span>
                            </div>
                            <span className="col-span-3 text-right">ایران _ تهران _ منطقه ۶</span>
                        </li>

                        <li className='grid grid-cols-5 sm:text-base text-xs'>
                            <div className="col-span-2 flex items-center gap-2">
                                <div className="centerOfParent"><Clock className='sm:w-4 sm:h-4 w-3 h-3 fill-primary-800' /></div>
                                <span className='text-natural_gray-950'>روز/ساعت</span>
                            </div>
                            <span className="col-span-3 text-right">روزهای زوج ساعت ۹:۰۰ـ۱۱:۰۰</span>
                        </li>
                        <li className='grid grid-cols-5 sm:text-base text-xs'>
                            <div className="col-span-2 flex items-center gap-2">
                                <div className="centerOfParent"><Calendar className='sm:w-4 sm:h-4 w-3 h-3 fill-primary-800' /></div>
                                <span className='text-natural_gray-950'>تاریخ</span>
                            </div>
                            <span className="col-span-3 text-right">از ۲۰ فروردین ۱۴۰۳ تا ۴ تیر ۱۴۰۳</span>
                        </li>
                        <li className='grid grid-cols-5 sm:text-base text-xs'>
                            <div className="col-span-2 flex items-center gap-2">
                                <div className="centerOfParent"><Alt className='sm:w-4 sm:h-4 w-3 h-3 fill-primary-800' /></div>
                                <span className='text-natural_gray-950'>مباحث تدریسی</span>
                            </div>
                            <span className="col-span-3 text-right ">گرامر زمان گذشته، حال و آینده| مکالمه از مبتدی تا پیشرفته</span>
                        </li>
                    </ul>
                </div>
            </div>
