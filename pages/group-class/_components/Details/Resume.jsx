                ...
                <div className="rounded-lg bg-natural_gray-50 w-full flex items-center justify-between px-4 py-2.5">
                    <div className="flex items-center gap-4">
                        <div className="centerOfParent rounded-full w-[60px] h-[60px] overflow-hidden">
                            <Image src='/images/image 144.png' width={0} height={0} sizes='100vw' className='w-full object-cover h-full' />
                        </div>
                        <p className='sm:text-base text-xs'>استاد کاک مهندس باسط</p>
                    </div>
                    <button type='button' className='rounded sm:text-base text-xs border-1.5 text-secondary-500 h-fit border-secondary-300 py-2 px-6 centerOfParent'>مشاهده</button>
                </div>
            </div>
        </>
    );
