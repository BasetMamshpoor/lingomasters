...
import TicketMessage from "@/features/profile/Support/TicketMessage";
import ChatInput from "@/features/profile/Support/ChatInput";
...
const Ticket = () => {
    ...
    const handleClose = async () => {
        const {success, errorMessage, successMessage} = await sendPostRequest('POST', `/tickets/close/${query.id}`,undefined,true)
        if (success) {
            addToast({
                title: "بسته شد",
