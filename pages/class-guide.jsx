        ...
        <>
            <div dir="rtl" className="container flex flex-col gap-20 ">
                ...
                <div className="flex gap-2">
                    <Link href="/public" className="sm:hidden flex gap-2 items-center">
                ...
                <div className="flex flex-col gap-8 lg:grid lg:grid-cols-2">
                    <Image width={100} height={100} alt={"image"} className="w-full h-full "
                    ...
                    <div className="flex flex-col gap-24 ">
                        <p className="text-sm sm:text-xl">
                            ...
                            <br/>
                            شما می توانید با نصب هر یک از این برنامه ها از کلاس های ما استفاده کنید و در فضای آنلاین به
                    ...
                    <div className="grid grid-cols-1 gap-16 sm:grid-cols-2 lg:grid-cols-3">
                        <div className="relative mx-auto h-56">
                            ...
                            <div
                                ...
                                <Image src="/images/class-gluide-box.png" width={60} height={60} alt=""
                        ...
                        <div className="relative mx-auto h-56">
                            ...
                            <div
                                className="relative bg-white bg-opacity-20 backdrop-blur-[20px] rounded-xl h-full shadow-lg z-10">
                                <Image src="/images/class-gluide-web.png" width={60} height={60} alt=""
                                       className="absolute -top-7 left-1/2 -translate-x-1/2 z-20"/>
                                <div
                                    className="flex flex-col items-center justify-center h-full pt-4 px-4 text-center gap-10">
                ...
                <div className="flex flex-col gap-20">
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                        ...
                        <Image width={50} height={50} alt={"image"} className="w-full h-full "
                ...
                <div className="flex flex-col gap-6 p-5">
                    <Image width={100} height={100} alt="" src="/images/class-gluide-Frame.png"
                           className="w-full h-full hidden sm:flex"/>
                    <Image width={100} height={100} alt="" src="/images/class-gluide-longomasters-mobile.png"
                ...
                <div className="flex lg:items-center justify-between gap-6 lg:flex-row flex-col">
                    ...
                    <Link href="/group-class"
                          className="self-end px-6 py-2 w-44 text-white bg-primary-600 border-1.5  border-primary-600 rounded-md">رزرو
                        کلاس گروهی</Link>
                </div>
                <div className="flex flex-col gap-20">
                    <div className="flex items-center gap-2 m-auto">
