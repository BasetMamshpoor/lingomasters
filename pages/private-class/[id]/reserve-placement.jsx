...
import TabSkill from "@/features/private-class/reserve/TabSkill";
        ...
        !isLoading ? (data && <>
            <main className='my-6' dir='rtl'>
                <div className="container">
                    <Progress title="کلاس تعیین سطح" link='private-class' active={steps} steps={stepsList}
                                ...
                                : <form onSubmit={handleNext}
                                    ...
                                    <div className="flex flex-col gap-10">
                                        ...
                                        <TabTeachingType
                                            ...
                                            setSelected={setState}
                                            selected={state}/>
                                        <TabSkill data={data.class_types_details} state={state} setState={setState}/>
