            ...
            <div className="centerOfParent my-10" dir='auto'>
                <div className="centerOfParent flex-col gap-6 p-6 max-w-[616px] shadow rounded-lg bg-white">
                    ...
                    <div className="flex flex-col items-center gap-10">
                        ...
                        <p className='text-natural_gray-950 text-center'>پس از پرداخت هزینه بلافاصله کلیه اطلاعات کلاس انتخابی تان
                            جهت تایید رزرو، به استاد ارسال می‌گردد. در صورت عدم قبول کلاس توسط استاد، مبلغ پرداختی به
                            اعتبار شما اضافه می‌شود و می‌توانید هر زمان که بخواهید با همان استاد یا استاد دیگری کلاس
                            دیگری را رزرو نمایید.</p>
