        ...
        <>
            <div
                ...
                <div className="flex items-center justify-between gap-0.5 border-b mx-2">
                    <div
                        className="py-4 w-[88px] text-center px-2 bg-natural_gray-50 text-primary-800 border-b border-primary-800">
                                                ...
                                                return <tr key={t.time}>
                                                    <td
                                                        ...
                                                        ${t.status == 'inactive' ? '!bg-natural_gray-50 text-natural_gray-50 border-none'
                                                            : t.status == 'reserved' ? '!bg-natural_gray-50 text-natural_gray-50 border-none' : ''}`}>
                                                        {(t.status == 'open') ?
                                                            <Checkbox className='py-2' size='sm'><span
                                                                className='text-center sm:text-sm text-[10px]'>{t.time}</span></Checkbox> : null}
                                                        {t.status !== 'open' ? '-' : null}
                                                    </td>
                                                </tr>
                                            })}
