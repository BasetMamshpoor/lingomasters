...
const Calendar = ({setState, state, setSteps,id}) => {
    ...
    const {sendPostRequest, isLoading2} = usePostRequest()
        ...
        <>
            <div className="col-span-3 flex flex-col gap-6">
                ...
                <div className="flex items-end self-end gap-6">
                    ...
                    <button disabled={isLoading2}
                            onClick={handleSubmit} type='button'
                            className="w-44 effect-2 sm:py-4 py-2 sm:px-6 px-4 sm:text-base text-xs rounded disabled:bg-natural_gray-700 text-white bg-primary-600 sm:w-[140px] self-end">ثبت
                    </button>
                </div>
            </div>
        </>
