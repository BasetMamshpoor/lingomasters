            ...
            <div dir="rtl" className="container flex flex-col gap-20 ">
                ...
                <div className="flex flex-col gap-20">
                    ...
                    <p className="text-xs md:text-sm lg:text-lg">۱. اول از همه دکمه ورود اساتید رو میزنید و صفحه زیر
                        براتون باز میشه.</p>
                    <Image unoptimized src="/images/ProfessorRegistration.png" alt="ProfessorRegistration" width={100} height={100}
                           className="w-full"/>
                ...
                <div
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="text-xs md:text-sm lg:text-lg">
                            ...
                            <p>چه چیزی از این بهتر؟! داستان کسب درآمد شما با لینگومسترز هم همین است: لینگومسترز را معرفی کنید، پاداش بگیرید!</p>
                            <p>کافی است خدمات ما را به اساتید، مترجمین، زبان آموزان و یا اولیا معرفی کنید و از ثبت نام اساتید، مترجمین، زبان آموزان و خرید آنها،<br/>
                                کسب درآمد کنید.</p>
                            <br/>
                            <p>راهنمای گام‌ به ‌گام کسب درآمد با لینگومسترز</p>
                            <div className="flex  gap-3 md:gap-5 lg:gap-8">
                                <p>1.</p>
                                <p className="">در لینگومسترز به عنوان استاد، مترجم و یا زبان آموز عضو شوید.</p>
                            </div>
                            <div className="flex  gap-3 md:gap-5 lg:gap-8">
                                <p>2.</p>
                            ...
                            <div className="flex  gap-3 md:gap-5 lg:gap-8">
                                <p>3.</p>
                                <p className=""> بدون محدودیت به تعداد نامحدود استاد، مترجم و یا زبان آموز را با کد دعوت خود به لینگومسترز دعوت کنید.</p>
                            </div>
                            <div className="flex gap-3 md:gap-5 lg:gap-8">
                                <p>4.</p>
                                <p className="">با ثبت نام کامل اساتید و مترجمین مبلغ 100،000 تومان و با ثبت نام کامل زبان آموزان، مبلغ 10،000 تومان و روی اولین خرید <br/><span>آنها، %۲۰ کارمزد لینگومسترز را پاداش بگیرید و زیر ۲۴ ساعت، درآمد خود را نقد کنید.</span> </p>
                            </div>
                        </div>
                        <p className="text-xs md:text-sm lg:text-lg text-warning-700">
                            نکته بسیار مهم:<br/>
                            افراد دعوت شده فقط تا ۲۴ ساعت بعد از ثبت‌ نام در سایت لینگومسترز میتوانند کد دعوت شما را در
                            حساب کاربری خودشان ثبت کنند در صورتی که وارد کردن کد دعوت را فراموش کنند، پس از گذشت ۲۴
                            ساعت، امکان استفاده از کد دعوت شما دیگر وجود نخواهد داشت.
                        </p>
                    </div>
                </div>
            </div>
