                ...
                <div
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="text-xs md:text-sm lg:text-lg">
                            ...
                            <div className="flex  gap-3 md:gap-5 lg:gap-8">
                                <p>3.</p>
                                <p className=""> بدون محدودیت به تعداد نامحدود استاد، مترجم و یا زبان آموز را با کد دعوت
                                    خود به لینگومسترز دعوت کنید.</p>
                            </div>
                            <div className="flex gap-3 md:gap-5 lg:gap-8">
                                <p>4.</p>
                                <p className="">با ثبت نام کامل اساتید و مترجمین مبلغ 100،000 تومان و با ثبت نام کامل
                                    زبان آموزان، مبلغ 10،000 تومان و روی اولین خرید <br/><span>آنها، %۲۰ کارمزد لینگومسترز را پاداش بگیرید و زیر ۲۴ ساعت، درآمد خود را نقد کنید.</span>
                                </p>
                            </div>
                        </div>
