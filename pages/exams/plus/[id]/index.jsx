    ...
    return (
        <>
            {loading ?
                ...
                : <div dir="rtl" className='grid lg:grid-cols-12 grid-cols-1 my-10'>
                    <div className="lg:col-span-3 flex flex-col gap-6">
                        ...
                        <div className="flex flex-col gap-5">
                            ...
                            <ul className="flex flex-col gap-2.5 text-natural_gray-900 sm:text-sm text-xs [&>li]:py-2.5 [&>li]:px-5 [&>li]:text-natural_gray-950">
                                <li>هوش مصنوعی چیست و چگونه کار میکند؟</li>
                                <li>امکان مقایسه دانش‌آموزان در سطح ملی</li>
                                <li>افزایش شانس پذیرش در دانشگاه‌ها</li>
                            </ul>
                        </div>
                    </div>
                    {data && <div className="flex flex-col gap-6 lg:col-span-9">
                        <div
