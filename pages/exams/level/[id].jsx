            ...
            <div className="flex flex-col gap-8">
                ...
                <div
                    ...
                    <div className="flex flex-col gap-6 w-full lg:w-1/2">
                        ...
                        <div className="flex items-center w-full">
                            <div className="flex items-center gap-1 w-1/2">
                                <p className="text-sm md:text-base text-primary-950 font-medium">اطلاعات خرید آزمون</p>
                            </div>
                        </div>
                        <div className="flex items-center w-full">
                            <div className="flex items-center gap-1 w-1/2">
                ...
                <Link href="/"
                      className="md:hidden w-full flex items-center justify-center px-8 py-2 text-base rounded-md bg-primary-700 text-white ">شروع آزمون</Link>
            </div>
        </>
    );
};
