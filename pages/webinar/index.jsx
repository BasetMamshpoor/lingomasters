                ...
                <div className="container flex flex-col gap-6">
                    <div className="flex flex-col gap-2">
                        <Alert color="warning" variant="faded"
                               description="📌وبینارهای تعریف شده توسط اساتید لینگومسترز، در صورت عدم تکمیل ظرفیت، تا ۲۴ ساعت قبل از تاریخ شروع کلاس، توسط لینگومسترز لغو خواهند شد."/>
                        <Alert color="warning" variant="faded"
                               description="📌 وبینارهای تعریف شده توسط اساتید لینگومسترز، صرفا تا ۲۴ ساعت قبل از شروع کلاس، بدون هیچ هزینه ای، قابل انصراف هستند و کل مبلغ پرداختی شما از بابت کلاس گروهی به کیف پول شما برگشت داده می شود و پس از آن قابلیت انصراف ندارند. "/>
                    </div>
